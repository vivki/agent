...
func TestMetricsBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			for i := 0; i < ms.Len(); i++ {
				switch ms.At(i).Name() {
				case "nginx.certificate.time_to_expiration":
					assert.False(t, validatedMetrics["nginx.certificate.time_to_expiration"], "Found a duplicate in the metrics slice: nginx.certificate.time_to_expiration")
					validatedMetrics["nginx.certificate.time_to_expiration"] = true
