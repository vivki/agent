...
var MetricsInfo = metricsInfo{
	NginxCertificateTimeToExpiration: metricInfo{
		Name: "nginx.certificate.time_to_expiration",
	},
}
...
type metricNginxCertificateTimeToExpiration struct {
	data     pmetric.Metric // data buffer for generated metric.
	config   MetricConfig   // metric config provided by user.
	capacity int            // max observed number of data points added to the metric.
}

// init fills nginx.certificate.time_to_expiration metric with initial data.
...
func (m *metricNginxCertificateTimeToExpiration) updateCapacity() {
...
func (m *metricNginxCertificateTimeToExpiration) emit(metrics pmetric.MetricSlice) {
...
func newMetricNginxCertificateTimeToExpiration(cfg MetricConfig) metricNginxCertificateTimeToExpiration {
	m := metricNginxCertificateTimeToExpiration{config: cfg}
	if cfg.Enabled {
...
type MetricsBuilder struct {
	...
	metricNginxCertificateTimeToExpiration metricNginxCertificateTimeToExpiration
}
...
func NewMetricsBuilder(mbc MetricsBuilderConfig, settings receiver.Settings, options ...MetricBuilderOption) *MetricsBuilder {
	mb := &MetricsBuilder{
		...
		metricNginxCertificateTimeToExpiration: newMetricNginxCertificateTimeToExpiration(mbc.Metrics.NginxCertificateTimeToExpiration),
...
func (mb *MetricsBuilder) EmitForResource(options ...ResourceMetricsOption) {
	...
	mb.metricNginxCertificateTimeToExpiration.emit(ils.Metrics())
